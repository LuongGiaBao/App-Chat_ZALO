...
export declare type UnreadMessageResult = UnreadMessageSucceededResult | ChatKittyFailedResult;
export declare class UnreadMessageSucceededResult extends ChatKittySucceededResult {
    message: Message;
    constructor(message: Message);
}
...
export declare type UpdateMessagePropertiesResult = UpdatedMessagePropertiesSucceededResult | ChatKittyFailedResult;
export declare class UpdatedMessagePropertiesSucceededResult extends ChatKittySucceededResult {
    message: Message;
    constructor(message: Message);
}
