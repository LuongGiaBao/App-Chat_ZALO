...
class ChatKittyPaginator {
    constructor(items, page, stompX, contentName, prevRelay, nextRelay, parameters, mapper, asyncMapper) {
        this.items = items;
        this.page = page;
        this.stompX = stompX;
    ...
    static createInstance(request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return new ChatKittyPaginator(items, page.page, request.stompX, request.contentName, page._relays.prev, page._relays.next, request.parameters, mapper, asyncMapper);
        });
    }
    get hasPrevPage() {
    ...
    getPage(relay) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return new ChatKittyPaginator(items, page.page, this.stompX, this.contentName, page._relays.prev, page._relays.next, this.parameters, this.mapper, this.asyncMapper);
        });
    }
}
