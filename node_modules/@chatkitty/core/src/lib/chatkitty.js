    ...
    retrieveChannelContext(request) {
        return new Promise((resolve) => {
            this.stompX.relayResource({
                ...
                onSuccess: (context) => {
                    resolve(new channel_1.RetrieveChannelContextSucceededResult(context));
                },
                onError: (error) => {
                    resolve(new result_1.ChatKittyFailedResult(error));
                },
    ...
    unreadMessage(request) {
        return new Promise((resolve) => {
            this.stompX.sendAction({
                ...
                body: {},
                onSent: () => resolve(new message_1.UnreadMessageSucceededResult(request.message)),
                onError: (error) => resolve(new result_1.ChatKittyFailedResult(error)),
            });
        });
    }
    ...
    updateMessageProperties(request) {
        return new Promise((resolve) => {
            this.stompX.sendAction({
                ...
                onSuccess: (message) => resolve(new message_1.UpdatedMessagePropertiesSucceededResult(message)),
                onError: (error) => resolve(new result_1.ChatKittyFailedResult(error)),
            });
        });
    }
